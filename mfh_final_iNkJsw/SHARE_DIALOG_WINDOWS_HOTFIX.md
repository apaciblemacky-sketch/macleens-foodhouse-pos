...
This update replaces the primary Share action with a built-in Macleen's share dialog for Food House, Food products, Craft Shop, and Craft products. It offers Facebook, Email, and Copy Link. WhatsApp and Telegram were removed in the follow-up share-menu refinement. On mobile devices that support Web Share, a separate **More Apps…** button is available. Desktop Windows no longer invokes the failing system share sheet by default.
